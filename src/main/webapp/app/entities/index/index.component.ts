...
export class IndexComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.indexService
      ...
      .subscribe(
        (res: HttpResponse<IIndex[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInIndices(): void {
    this.eventSubscriber = this.eventManager.subscribe('indexListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IIndex[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
